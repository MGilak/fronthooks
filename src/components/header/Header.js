...
const Header = () => {
  ...
  const [showSubMainMenu, setShowSubMainMenu] = useState(false);
  const [showSubMenu, setShowSubMenu] = useState(false);
  const [showProfile, setShowProfile] = useState(false);

  const subMainMenuRef = useRef();
  const sideMenuRef = useRef();
  const subProfileRef = useRef();
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        subMainMenuRef.current &&
        !subMainMenuRef.current.contains(event.target)
      ) {
        setShowSubMainMenu(false);
      }

      if (
        subProfileRef.current &&
        !subProfileRef.current.contains(event.target)
      ) {
  ...
  }, [sideMenuRef, subMainMenuRef, subProfileRef]);

  return (
    <header
      className=" sticky flex justify-center top-0 w-full transiton-all duration-100 ease-out z-20 shadow-menu md:shadow-none backdrop-blur-2xl
    blur-0 opacity-100"
    >
      <div
        className={`bg-[#00000080]  fixed left-0 top-0 bottom-0 w-full h-screen z-10 ${
          !showMenu && "hidden"
        }`}
      ></div>
      <div className="container xl:max-w-screen-xl top-0 py-2 md:py-2 px-4 md:px-2">
        <div className="w-full mx-auto">
          <nav className="flex items-center justify-between">
            <div className="md:hidden flex items-center gap-5">
              <div className=" text-[#555775]">
                <button onClick={showSidMenu}>
                  <svg
                    stroke="currentColor"
                    fill="none"
                    stroke-width="0"
                    viewBox="0 0 24 24"
                    class="h-7 w-7 text-skin-icon-secondary-dk"
                    height="1em"
                    width="1em"
                ...
                <a href="##">
                  <button>
                    <svg
                      ...
                      viewBox="0 0 35 32"
                      fill="none"
                      class="h-8 w-8 fill-primary-900 block md:hidden"
                    >
                      <path
                        fill="currenColor"
            ...
            <div className="right gap-2 md:flex hidden">
              <Link className="" to="/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="140"
              ...
              <ul className="gap-8 md:flex items-center text-gray-500">
                <li className="flex gap-x-2 items-center hover:text-blue-700 transition-all ease-in">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  <Link className="font-light" to="/courses">
                    دوره‌های آموزشی
                  </Link>
                </li>
                <li className="flex gap-x-2 items-center hover:text-blue-700 transition-all ease-in">
                  ...
                  <Link className="font-light" to="/hired">
                    استخدامی بچه‌ها
                  </Link>
                </li>
                <li>
                  <button
                    ref={subMainMenuRef}
                    onClick={() => setShowSubMainMenu(!showSubMainMenu)}
                    className={`relative flex gap-x-2 items-center hover:text-blue-700 transition-all duration-300 ease-in ${
                      showSubMainMenu ? "overflow-visible" : "overflow-hidden"
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    {/* SubMenu in MainMenu */}
                    <div
                      className={`hover:text-gray-500 absolute p-2 pt-3 z-20 bg-white rounded-lg top-8 overflow-hidden transition-all duration-200 ease-in cubic- ${
                        showSubMainMenu ? "h-36 opacity-100" : "h-0 opacity-0"
                      }`}
                    >
                      <ul className="flex flex-col text-skin-base opacity-80 pb-4">
                        <a href="##">
                          <li className="flex gap-2 rounded-lg hover:bg-gray-100 p-2 pr-3 pl-3 transition duration-100 ease-linear">
                            <span>
                              <svg
                                stroke="currentColor"
                                fill="currentColor"
                                ...
                                class="opacity-70 md:opacity-100 h-5 w-5 ml-1 md:text-skin-base"
                                height="1em"
                                width="1em"
                                xmlns="http://www.w3.org/2000/svg"
                              >
                            ...
                            <p>
                              <span class="whitespace-nowrap text-[16px]">
                                صفحه اینستاگرام
                              </span>
                            </p>
                          </li>
                        ...
                        <a href="##">
                          <li className="flex gap-2 rounded-lg hover:bg-gray-100 p-2 pr-3 pl-3 transition duration-100 ease-linear">
                            ...
                            <p>
                              <span class="text-[16px]">درباره ما</span>
                            </p>
                          </li>
                        </a>
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  strokeWidth="0"
                  viewBox="0 0 20 20"
                  className="text-secondary-700 w-4 h-4"
                  height="1em"
                  width="1em"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              {/* SubMenu in Profile Button */}
              <div
                className={`transition-all duration-200 ease-linear ${
                  showProfile
                    ? "max-h-96 opacity-100"
                    : "max-h-0 overflow-hidden opacity-0"
                } cursor-default absolute w-60 p-2 top-12 left-0 bg-white box-content rounded-xl text-secondary-700`}
              >
                <ul>
                  <li className="flex items-center gap-2 p-2 border-b mb-1">
                    <img
                  ...
                  <li className=" gap-2 px-4 py-1 hover:bg-gray-100 transition duration-200 ease-in  mb-1 rounded-lg font-bold text-sm">
                    <Link to="/profile">
                      <div className="flex items-center py-2 transition duration-200 ease-in hover:text-[#4a6dff]">
                        ...
                        <span className="block text-sm font-bold hover:text-primary-900">
                          حساب کاربری
                        </span>
                      </div>
                    </Link>
                  ...
                  <li className=" gap-2 px-4 py-1 hover:bg-gray-100  transition duration-200 ease-in mb-1 rounded-lg font-bold text-sm">
                    <a href="##">
                      <div className="flex items-center py-2 transition duration-200 ease-in hover:text-red-400">
                        <svg
                          stroke="currentColor"
                          fill="none"
                          stroke-width="0"
      ...
      <div
        ref={sideMenuRef}
        className={`z-20 absolute right-0 top-0 bg-white w-72 h-screen transition transition-300 ease-linear ${
          showMenu ? "translate-x-0" : "translate-x-[300px]"
        }`}
      >
        {/* SideMenu_header */}
        <div className="h-full">
          <div className="flex justify-between items-center border-b p-6 pb-2">
            <Link to="/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="140"
          ...
          {/* SideMenu_body */}
          <div className="pt-16 h-[76%]">
            <ul className="flex flex-col text-secondary-700 gap-6">
              <li>
                <a href="#">
                  <div className="flex items-center text-primary-900 font-bold">
                    <img
                      ...
                      alt=""
                    />
                    <span className="pr-7 flex gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 22 22"
                        fill="none"
                  ...
                  >
                    <button>
                      <img
                        ...
                        alt=""
                      />
                      <span className="pr-7 flex gap-2 items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                          fill="none"
                        ...
                        <svg
                          ...
                          stroke-width="0"
                          viewBox="0 0 24 24"
                          class={`h-5 w-5 pb-1 transition ease-in-out duration-300 ${
                    ...
                    {/* SubMenu in SideMenu */}
                    <div
                      className={`overflow-hidden transition-all duration-200 ease-in cubic- ${
                        !showSubMenu ? "h-0" : "h-32"
                      }`}
                    >
                      <ul className="flex flex-col gap-3 pt-4 pr-10">
                        <a href="##">
                          <li className="flex">
                            <span>
                              <svg
                            ...
                            <p>
                              <span class="text-sm">صفحه اینستاگرام</span>
                            </p>
                          </li>
                        </a>
                        ...
                        <a href="##">
                          <li className="flex">
                            ...
                            <p>
                              <span class="text-sm">کانال تلگرام</span>
                            </p>
                          </li>
                        </a>
                      </ul>
            ...
            <div className="flex justify-around">
              <div className="flex gap-4">
                <div className="relative">
                  <a href="##" className="">
                    <div className="overflow-hidden border-2 pb-2 w-11 h-11 rounded-full bg-[#bdbdbd] flex  items-center justify-center text-white text-2xl">
                      <img
                  ...
                  <span className="bottom-2 bg-success w-2 h-2 absolute rounded-full"></span>
                  <span className="bottom-2 bg-success animate-ping w-2 h-2 absolute rounded-full"></span>
                </div>

                <div className="flex flex-col">
                  <a href="#">
                    <span className="font-bold">محمود گیلک</span>
                  </a>

                  <span className="opacity-70 font-light">دانشجو</span>
                </div>
              </div>

              <a
                className="hover:bg-[#0000000a] transition duration-100 ease-in w-9 h-9 rounded-2xl flex items-center justify-center"
                href="##"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 14 14"
                  fill="none"
                  class="h-5 w-5 text-secondary-700 opacity-100"
                >
                  <path
                    stroke="currentColor"
                    stroke-linecap="round"
